...
class MagRepack_Dialog_Main
{
	...
	class Controls
	{
		...
		class MR_Logo: outlw_MR_RscPicture
		{
			...
			text = "s_player\outlw_magRepack\Images\MR_logo.paa";
		...
		*/
		...
		{
			idc = 2210;
			text = "s_player\outlw_magRepack\Images\MR_SourceGradient.paa";
		...
		{
			idc = 2211;
			text = "s_player\outlw_magRepack\Images\MR_TargetGradient.paa";
